...
UnitCompositions = {
	Allied = {
		...
		-- 10 minutes onwards
		{ Infantry = { "e3", "e1", "e1", "e1", "e3", "e1", "e1", "e1", AlliedAdvancedInfantry, "e1", "e3", "e1", "e1" }, Vehicles = { "2tnk", "ifv.ai", "delp.ai", "apc.ai", "arty" }, MinTime = DateTime.Minutes(10) },
		...
		{ Infantry = {}, Vehicles = { "apc.ai", "jeep", "ifv.ai", "delp.ai", "ifv.ai", "apc.ai" }, MinTime = DateTime.Minutes(10) },
