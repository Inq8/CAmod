...
WorldLoaded = function()
	...
	SendNodUnits(Nodspawn3.Location, NodCyborgUnitTypes, 60)
	SendNodUnits(Nodspawn3.Location, NodLightUnitTypes, 50)
	SendNodUnits(Nodspawn4.Location, NodHeavyUnitTypes, 40)
	SendNodUnits(Nodspawn4.Location, NodCyborgUnitTypes, 60)
	SendAlliedUnits(Usaspawn.Location, AlliedUnitTypes, 60)
	SendAlliedUnits(Helispawn1.Location, AlliedUnitTypes, 60)
	SendAlliedUnits(Usaspawn2.Location, AlliedUnitTypes, 60)
	SendSovietUnits(Sovietspawn.Location, SovietUnitTypes, 70)
	SendSovietUnits(Sovietspawn2.Location, SovietHeavyUnitTypes, 70)
	SendSovietUnits(wormhole1.Location, SovietUnitTypes, 70)
	SendSovietUnits(wormhole2.Location, SovietUnitTypes, 70)
	SendSovietUnits(wormhole3.Location, SovietHeavyUnitTypes, 70)
end
