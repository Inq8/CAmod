...
namespace OpenRA.Mods.CA.Projectiles
{
	...
	public class PlasmaBeam : IProjectile, ISync
	{
		...
		void CheckBlocked()
		{
			if (info.Blockable && BlocksProjectiles.AnyBlockingActorsBetween(args.SourceActor.World, args.SourceActor.Owner, target, info.CenterBeamWidth, out var blockedPos))
				target = blockedPos;
		}
