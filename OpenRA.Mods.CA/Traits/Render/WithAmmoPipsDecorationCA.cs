...
{
	public class WithAmmoPipsDecorationCAInfo : WithDecorationBaseInfo, Requires<AmmoPoolInfo>
	{
		...
		[Desc("Ammo pools to consider.")]
		public readonly string[] AmmoPools = null;

		[PaletteReference]
		public readonly string Palette = "chrome";

		public override object Create(ActorInitializer init) { return new WithAmmoPipsDecorationCA(init.Self, this); }
	}

	public class WithAmmoPipsDecorationCA : WithDecorationBase<WithAmmoPipsDecorationCAInfo>
	{
		readonly AmmoPool[] ammo;
		readonly Animation pips;

		public WithAmmoPipsDecorationCA(Actor self, WithAmmoPipsDecorationCAInfo info)
			: base(self, info)
		{
		...
		protected override IEnumerable<IRenderable> RenderDecoration(Actor self, WorldRenderer wr, int2 screenPos)
		{
			...
			{
				if (!Info.AmmoPools.Contains(a.Info.Name))
					continue;
